...
| 항목 | 내용 |
|------|------|
| **필드** | `name`, `destination`, `start_range`, `end_range`, `duration_days`, `target_member_count`, `invite_code`, `last_recommendation_mode`, `last_activity_at`, `confirmed_*` |
...
- `isScheduleRegistered` — `regular_schedule` ≥1 저장 시 true — **BR-USER-006**
