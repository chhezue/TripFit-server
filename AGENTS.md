...
**Wave Must/Nice/Out** — 이슈 `## Must Have`·스펙 `MVP: In scope`만으로 Must를 단정하지 않음. SSOT는 Wave Backlog(`#29`~`#32`) · harness `Wave Must / Nice / Out` 절.
...
- **`[미정]` chore:** 기획 미확정 항목은 **[#2](https://github.com/Central-MakeUs/TripFit-server/issues/2)** 에 모음 (하네스 `harness-workflow` · CONTRIBUTING)
...
- **ERD:** 고정이 아님 — 스키마 개선을 **적극 제안**, 승인 시 엔티티+`erd.md`만 최신화
